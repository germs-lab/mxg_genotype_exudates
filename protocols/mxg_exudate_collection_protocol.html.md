...
-   5-gallon buckets (for collecting waste sand and other trash) \### Incubation assembly One assembly per plant sampled, plus several extra to collect <u>control samples</u>. Quantities listed below are *per plant sampled*:

    -   

        (2) 30 mL plastic Luer lock syringes (used for root incubation and solution flushing/collection), plus addition
...
-   Glass beads
    ...
    -   1 mm fine beads (\~15 mL / 1 oz) to provide more realistic support and porosity
        ...
        -   [It is difficult to get good mixing between the 1mm and 3mm beads in the incubation assemblies. We should consider using 1mm beads only, or a slightly smaller size instead of 1mm, or layering the two sizes more carefully while filling the incubation syringe.]{.mark}
...
-   Cooler with ice packets (“blue ice”) for preservation of collected samples
    ...
    -   [We may switch to preserving samples on dry ice in the future, but this requires additional training and planning]{.mark}
...
-   **Initiate the incubation—** Add 10 mL of nutrient solution to the incubation assembly. Using the same “clean” syringe, [inject 5 mL of air into the bottom of the assembly to help distribute the incubation solution evenly through the incubation assembly.]{.mark} Close the stopcock, remove the injection syringe, and cover the end of the tubing with tinfoil to keep soil out of the assembly (Figure 9).
...
![Syringe and filter setup . Flow of "clean" nutrient stock depicted in green, "collection" stock depicted in red and "filtered" stock in magenta.](attachments/media/image_flow.png)



### Figures

![Stainless steel pipe screen to block glass beads from clogging syringe nozzle.](attachments/media/image1.jpeg){#fig-figure1}


![Incubation assembly (20 mL version).](attachments/media/image2.png){#fig-figure2}

![Soaking fine roots to help loosen and remove soil particles (or potting mix in this case).](attachments/media/image3.jpeg){#fig-figure3}

![An excavated and cleaned fine root system (Clatskanie field site).](attachments/media/image4.jpeg){#fig-figure4}

![Root system covered in moist sand for recovery period. Note the root partially visible at 10 o'clock; the root should be as completely covered in moist sand as possible to prevent it from drying out.](attachments/media/image5.jpeg){#fig-figure5}

![Loading the recovered root into an incubation assembly (30 mL syringe body).](attachments/media/image6.jpeg){#fig-figure6}

![Filling incubation assembly around root with coarse and fine glass beads.](attachments/media/image7.jpeg){#fig-figure7}

![Injecting nutrient solution into the bottom of the incubation assembly (note that this earlier version of the assembly lacks a syringe filter, and features 1/8" ID tubing instead of 1/16").](attachments/media/image8.jpeg){#fig-figure8}

![Completed incubation assembly.](attachments/media/image9.jpeg){#fig-figure9}

![Flush sample storage in 15 mL "Falcon" tubes (VWR brand).](attachments/media/image10.jpeg){#fig-figure10}

![Root excavation from a poplar plant grown in potting mix in the greenhouse. The root/soil "plug" has enough structure that it can be removed from the pot intact, and reassembled later.](attachments/media/image11.jpeg){#fig-figure11}

![Adding a 20 mL incubation assembly the to the root/soil plug, routing the solution collection tube to the top of the soil surface, and returning the entire assembly back to the original pot.](attachments/media/image12.jpeg){#fig-figure12}

![Re-potted plant with sample collection tube protruding from the surface. A shorter and narrower tube would reduce the amount of "dead" volume that needs to be managed.](attachments/media/image13.jpeg){#fig-figure13}

![Relatively young plants grown in field soil may lack enough root/soil "plug" structure to facilitate reassembly in the original tall/skinny pot. In these cases, the plant can be transferred to a wider pot, routing the end of the incubation syringe out a drainage hole, and twisting/folding the remaining root/soil plug to fit.](attachments/media/image14.jpeg){#fig-figure14}

![Another view of the incubation syringe protruding from the bottom of the new, wider pot.](attachments/media/image15.jpeg){#fig-figure15}
...
-   **Potting mix challenges**:
    ...
    -   Reuse original pot for reassembly (@fig-figure12).
-   **Field soil pots**: Re-pot into wider containers with syringe protruding from drainage holes (@fig-figure14 - @fig-figure15).
